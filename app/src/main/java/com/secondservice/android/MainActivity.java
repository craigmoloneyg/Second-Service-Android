...
public final class MainActivity extends Activity {
    ...
    private String lastPage = NavigationPolicy.HOME + "workspace";
    ...
    @Override public void onCreate(Bundle savedState) {
        ...
        web.setWebViewClient(new WebViewClient() {
            ...
            @Override public void onPageStarted(WebView view, String url, android.graphics.Bitmap icon) {
                pageFailed = false;
                if (NavigationPolicy.isApp(url)) lastPage = url;
                errorPanel.setVisibility(View.GONE);
            ...
            @Override public boolean onCreateWindow(WebView view, boolean dialog, boolean gesture, android.os.Message resultMsg) {
                ...
                popup.setWebViewClient(new WebViewClient() {
                    @Override public boolean shouldOverrideUrlLoading(WebView v, WebResourceRequest request) {
                        ...
                        if (NavigationPolicy.isInternal(target)) web.loadUrl(target);
        ...
        if (savedState != null) lastPage = savedState.getString("lastPage", NavigationPolicy.HOME + "workspace");
