...
const stories={
 overview:'A busy venue can still be leaking profit. Garnish brings the headline numbers into one commercial snapshot so you can see what needs attention before the month-end accounts tell you too late.',
 'profit-recovery':'Margin does not disappear in one dramatic moment. It leaks through purchasing, labour, portioning and pricing. Garnish exposes those leaks early, ranks the evidence and turns them into a recovery plan you can actually run.',
 purchasing:'Every supplier increase that goes unnoticed becomes tomorrow\'s food cost. Garnish turns invoices into live ingredient intelligence, purchasing history and price-movement visibility before cost creep gets comfortable.',
 labour:'Revenue can look healthy while labour quietly eats the margin underneath it. Garnish puts wage spend beside trading reality so you can see where the two stop moving together.',
 'menu-costing':'The menu is where theory becomes cash. Cost every plate against real supplier pricing, see actual portion economics and stop high-volume dishes from disguising weak contribution.',
 ...
 square:'Sales volume without margin visibility is noise. Bring live Square activity into the cost picture so a popular dish can no longer hide a weak margin.',
...
function addUnderlay(){
 ...
 document.querySelectorAll('.p2p-page').forEach(v=>{
   ...
   box.innerHTML='<div class="eyebrow">Built by hospitality, not around it</div><h3>The next generation of operators will know their numbers in real time.</h3><p>Garnish is informed by hospitality experience spanning Powerscourt\'s Gordon Ramsay operation, Marco Pierre White\'s Steakhouse and executive-level kitchen leadership. That experience is the point: this is not generic accounting software wearing a chef jacket. Garnish connects purchasing, recipes, sales, labour and accounting into one commercial view so decisions happen while they can still change the result. Code calculates the numbers. AI interprets the evidence. You stay in control.</p><div class="garnish-sales-grid"><div class="garnish-sales-point"><strong>Cost every plate</strong><span>Live invoice pricing flows into ingredient and recipe costs before yesterday\'s cost becomes today\'s mistake.</span></div><div class="garnish-sales-point"><strong>See margin leaks</strong><span>Find high-volume dishes, supplier moves and cost drift before they disappear into month-end.</span></div><div class="garnish-sales-point"><strong>Connect the venue</strong><span>Square, MYOB, invoices and recipes stop living in separate commercial universes.</span></div><div class="garnish-sales-point"><strong>Stay ahead</strong><span>The venues that can see margin faster can respond faster. Garnish gives you that visibility without taking the decision out of your hands.</span></div></div>';
   v.appendChild(box);
 });
}
function addHomePitch(){
 ...
 pitch.innerHTML='<div class="kicker">Why Garnish exists</div><h2>Hospitality has changed. Running the venue from instinct alone is no longer enough.</h2><p>Supplier invoices tell one story. Square tells another. MYOB tells another. Recipes live somewhere else again. Meanwhile food costs move, wages move, customers move and margin gets squeezed in the gaps. Garnish closes those gaps. It was shaped by experience inside serious hospitality operations, including Powerscourt\'s Gordon Ramsay operation and Marco Pierre White\'s Steakhouse, then built for the operator who wants the same commercial discipline without adding another layer of admin. The venues that connect this information early gain a clearer view of where profit is created and where it is being surrendered.</p><div class="garnish-sales-grid"><div class="garnish-sales-point"><strong>Invoices → costs</strong><span>Turn supplier documents into live ingredient intelligence instead of filing cabinets and forgotten PDFs.</span></div><div class="garnish-sales-point"><strong>Recipes → margins</strong><span>Know portion cost, food cost percentage and contribution before the menu makes the decision for you.</span></div><div class="garnish-sales-point"><strong>Sales → reality</strong><span>Use Square activity to separate what sells from what actually earns.</span></div><div class="garnish-sales-point"><strong>Accounts → context</strong><span>Bring MYOB into the same commercial picture so the operational story and accounting story finally meet.</span></div></div>';
