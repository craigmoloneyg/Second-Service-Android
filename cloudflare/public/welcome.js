(() => {
  ...
  home.id = 'p2p-home';
  home.innerHTML = `<section class="p2p-hero"><div><p class="p2p-eyebrow">Hospitality intelligence, plated clean.</p><h1 tabindex="-1">Know the numbers.<br><em>Keep the margin.</em></h1><p class="p2p-intro">The commercial operating system for hospitality. Bring invoices, recipes, Square, MYOB and labour into one place, then see what is really making money.</p><div class="p2p-actions"><button class="p2p-primary" data-view="invoices">Upload invoices <span aria-hidden="true">↗</span></button><button class="p2p-secondary" data-view="dashboard">Open dashboard</button></div><p class="p2p-helper">PDFs and images · Up to 75 invoices per batch</p></div><div class="p2p-art" aria-hidden="true"><div class="p2p-plate"></div><div class="p2p-receipt"><div class="p2p-paper-title">From noise to clarity.</div><div class="p2p-paper-small">Make every ingredient count</div><div class="p2p-paper-row"><span>Supplier invoices</span><span>01</span></div><div class="p2p-paper-row"><span>Ingredient costs</span><span>02</span></div><div class="p2p-paper-row"><span>Menu margins</span><span>03</span></div></div><div class="p2p-seal"><span>↗</span>Clarity for your next service</div></div></section><div class="p2p-section-title"><h2>Start with the part costing you money</h2><span>One venue. One commercial picture.</span></div><section class="p2p-tiles" aria-label="Quick actions"><button class="p2p-tile" data-view="invoices"><span class="p2p-number">01 / PURCHASING</span><strong>Turn invoices into cost intelligence.</strong><p>Upload supplier documents and review the costs extracted from each one.</p></button><button class="p2p-tile" data-view="menu"><span class="p2p-number">02 / MENU COSTING</span><strong>Know the margin on every plate.</strong><p>Build recipes from ingredient prices and calculate your portion costs.</p></button><button class="p2p-tile" data-view="dashboard"><span class="p2p-number">03 / THE BIG PICTURE</span><strong>See where profit disappears.</strong><p>Open your workspace to review the figures and explore your next steps.</p></button></section><footer class="p2p-bottom"><span>Garnish · Built for the business behind hospitality.</span><span>Costs in focus. Food at heart.</span></footer>`;
