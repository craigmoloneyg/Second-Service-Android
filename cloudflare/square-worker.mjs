...
export default {
  async fetch(request,env,ctx){
    ...
    if(request.method==='GET'&&type.includes('text/html')){
      return new HTMLRewriter().on('body',{element(e){e.append('<script src="/square-ui-production.js?v=3" defer></script><script src="/page-router.js?v=4" defer></script><script src="/commercial-ui.js?v=2" defer></script><script src="/core-ui-fix.js?v=3" defer></script><script src="/profit-intelligence.js?v=3" defer></script>',{html:true});}}).transform(response);
    }
    return response;
  }
};
